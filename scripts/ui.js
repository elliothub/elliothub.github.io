...
Events.on('display-name', e => {
    ...
    $displayName.textContent = 'Votre nom est : ' + me.displayName;
...
class PeerUI {
    ...
    html() {
        return `
            <label class="column center" title="Clickez pour envoyer des fichiers, ou clickez droit pour envoyer un message">
